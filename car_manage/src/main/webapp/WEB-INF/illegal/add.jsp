			...
			<div class="row" >
				<div class=" col-md-offset-3 col-md-6" >
					...
					<div class="contact-form">
						<form id="contact-form" role="form" novalidate="novalidate" action="illegal/insert.do" method="post"> 
							<div class="form-group has-feedback">
								<label for="subject">违章时间</label>
								<input type="text" class="form-control" id="etime" name="etime" placeholder="">
							</div>
							<div class="form-group has-feedback">
							...
							<div class="form-group has-feedback">
								<label for="subject">违章金额</label>
								<input type="text" class="form-control" id="emoney" name="emoney" placeholder="">
							</div>
							<div class="form-group has-feedback">
								<label for="subject">违章地址</label>
								<input type="text" class="form-control" id="eaddr" name="eaddr" placeholder="">
							</div>
							<div class="form-group has-feedback">
								<label for="message">违章原因</label>
								<textarea class="form-control" rows="6" id="ereason" name="ereason" placeholder=""></textarea>
							</div>
	...
	function addMaintain(){
		...
		$.ajax({
			...
			success:function(result){
				window.location.href = "illegal/illegalList.do";
			}
		})
	} 
